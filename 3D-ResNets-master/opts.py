...
def parse_opts():
    ...
    #                     default='/home/zhangyong/ResNet-X',
    #                     type=Path,
    #                     help='Root directory path')
    # parser.add_argument('--video_path',
    #                     default='/home/zhangyong/3d_data/ucf101_videos/jpg',
    #                     type=Path,
    #                     help='Directory path of videos')
    # parser.add_argument('--annotation_path',
    #                     default='/home/zhangyong/3d_data/json_class/ucf101_02.json',
    #                     type=Path,
    #                     help='Annotation file path')
    # parser.add_argument('--result_path',
    #                     default='/home/zhangyong/ResNet-X/results-add-dense',
    #                     type=Path,
    ...
    parser.add_argument('--root_path',
                        ...
                        help='Root directory path')
    parser.add_argument('--video_path',
                        default='/home/zhangyong/IsoGD_data/IsoGD_videos/jpg',
                        type=Path,
                        help='Directory path of videos')
    parser.add_argument('--annotation_path',
                        default='/home/zhangyong/IsoGD_data/IsoGD_labels/json_rgb/ucf101_01.json',
                        type=Path,
                        help='Annotation file path')
    parser.add_argument('--result_path',
                        default='/home/zhangyong/ResNet-X/IsoGD_results_50_MFres',
                        type=Path,
                        help='Result directory path')
    ...
    parser.add_argument('--pretrain_path',
                        # default='/home/zhangyong/ResNet-X/results-add-dense/save_40.pth',
                        default=None,
                        type=Path,
    ...
    parser.add_argument('--resume_path',
                        # default='/home/zhangyong/ResNet-X/results-add-dense/save_10.pth',
                        default=None,
                        type=Path,
